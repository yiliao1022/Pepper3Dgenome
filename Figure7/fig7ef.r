...
mydata2_filter <-mydata2 %>% filter(Tissues=='All') %>% filter(Types=='Specific' | Types=='Shared')
wilcox.test(Tau~Types, data = mydata2_filter,  alternative ="less", paired = FALSE)
mydata2_specific <-mydata2 %>% filter(Tissues=='All') %>% filter(Types=='Specific')
mydata2_Shared <-mydata2 %>% filter(Tissues=='All') %>% filter(Types=='Shared')
lengths (mydata2_specific)
lengths (mydata2_Shared)


mydata2_filter <-mydata2 %>% filter(Tissues=='GR') %>% filter(Types=='Specific' | Types=='Shared')
wilcox.test(Tau~Types, data = mydata2_filter,  alternative ="less", paired = FALSE)
mydata2_specific <-mydata2 %>% filter(Tissues=='GR') %>% filter(Types=='Specific')
mydata2_Shared <-mydata2 %>% filter(Tissues=='GR') %>% filter(Types=='Shared')
lengths (mydata2_specific)
lengths (mydata2_Shared)
...
mydata2_filter <-mydata2 %>% filter(Tissues=='HL') %>% filter(Types=='Specific' | Types=='Shared')
wilcox.test(Tau~Types, data = mydata2_filter,  alternative ="less", paired = FALSE)
mydata2_specific <-mydata2 %>% filter(Tissues=='HL') %>% filter(Types=='Specific')
mydata2_Shared <-mydata2 %>% filter(Tissues=='HL') %>% filter(Types=='Shared')
lengths (mydata2_specific)
lengths (mydata2_Shared)
...
mydata2_filter <-mydata2 %>% filter(Tissues=='TZ') %>% filter(Types=='Specific' | Types=='Shared')
wilcox.test(Tau~Types, data = mydata2_filter, alternative ="less", paired = FALSE)
mydata2_specific <-mydata2 %>% filter(Tissues=='TZ') %>% filter(Types=='Specific')
mydata2_Shared <-mydata2 %>% filter(Tissues=='TZ') %>% filter(Types=='Shared')
lengths (mydata2_specific)
lengths (mydata2_Shared)
...
mydata2_filter <-mydata2 %>% filter(Tissues=='YP') %>% filter(Types=='Specific' | Types=='Shared')
wilcox.test(Tau~Types, data = mydata2_filter, alternative ="less", paired = FALSE)
mydata2_specific <-mydata2 %>% filter(Tissues=='YP') %>% filter(Types=='Specific')
mydata2_Shared <-mydata2 %>% filter(Tissues=='YP') %>% filter(Types=='Shared')
lengths (mydata2_specific)
lengths (mydata2_Shared)
...
mydata3_filter <-mydata3 %>% filter(Tissues=='HLvsGR')  %>% filter(Types=='shared' | Types=='speci')
wilcox.test(Density~Types, data = mydata3_filter, alternative ="less", paired = FALSE) 
mydata3_specific <-mydata3 %>% filter(Tissues=='HLvsGR') %>% filter(Types=='speci')
mydata3_Shared <-mydata3 %>% filter(Tissues=='HLvsGR') %>% filter(Types=='shared')
lengths (mydata3_specific)
lengths (mydata3_Shared)

mydata3_filter <-mydata3 %>% filter(Tissues=='HLvsTZ')  %>% filter(Types=='shared' | Types=='speci')
wilcox.test(Density~Types, data = mydata3_filter, alternative ="less", paired = FALSE) 
mydata3_specific <-mydata3 %>% filter(Tissues=='HLvsTZ') %>% filter(Types=='speci')
mydata3_Shared <-mydata3 %>% filter(Tissues=='HLvsTZ') %>% filter(Types=='shared')
lengths (mydata3_specific)
lengths (mydata3_Shared)

mydata3_filter <-mydata3 %>% filter(Tissues=='TZvsGR')  %>% filter(Types=='shared' | Types=='speci')
wilcox.test(Density~Types, data = mydata3_filter, alternative ="less", paired = FALSE) 
mydata3_specific <-mydata3 %>% filter(Tissues=='TZvsGR') %>% filter(Types=='speci')
mydata3_Shared <-mydata3 %>% filter(Tissues=='TZvsGR') %>% filter(Types=='shared')
lengths (mydata3_specific)
lengths (mydata3_Shared)

mydata3_filter <-mydata3 %>% filter(Tissues=='YPvsGR')  %>% filter(Types=='shared' | Types=='speci')
wilcox.test(Density~Types, data = mydata3_filter,  alternative ="less", paired = FALSE) 
mydata3_specific <-mydata3 %>% filter(Tissues=='YPvsGR') %>% filter(Types=='speci')
mydata3_Shared <-mydata3 %>% filter(Tissues=='YPvsGR') %>% filter(Types=='shared')
lengths (mydata3_specific)
lengths (mydata3_Shared)

mydata3_filter <-mydata3 %>% filter(Tissues=='YPvsHL')  %>% filter(Types=='shared' | Types=='speci')
wilcox.test(Density~Types, data = mydata3_filter, alternative ="less", paired = FALSE) 
mydata3_specific <-mydata3 %>% filter(Tissues=='YPvsHL') %>% filter(Types=='speci')
mydata3_Shared <-mydata3 %>% filter(Tissues=='YPvsHL') %>% filter(Types=='shared')
lengths (mydata3_specific)
lengths (mydata3_Shared)

mydata3_filter <-mydata3 %>% filter(Tissues=='YPvsTZ')  %>% filter(Types=='shared' | Types=='speci')
wilcox.test(Density~Types, data = mydata3_filter,  alternative ="less", paired = FALSE) 
mydata3_specific <-mydata3 %>% filter(Tissues=='YPvsTZ') %>% filter(Types=='speci')
mydata3_Shared <-mydata3 %>% filter(Tissues=='YPvsTZ') %>% filter(Types=='shared')
lengths (mydata3_specific)
lengths (mydata3_Shared)
